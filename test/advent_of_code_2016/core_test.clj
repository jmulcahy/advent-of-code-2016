...
(deftest first-match-test
  (testing "find a match"
    (let [maybe-matches (seq '((1 1) (2 1) (3 1) (4 1)))
      ...
      (is (= (first-match maybe-matches match-against) '(3 1))))))
